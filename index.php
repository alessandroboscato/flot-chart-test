...
// collect data
// $num_rows = mysql_num_rows($result); //total orders
// var_dump($num_rows);
//
//
// //print table
...
<div id="placeholder" style="width:600px;height:300px"></div>
  ...
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/flot/0.8.1/jquery.flot.time.min.js "></script>
